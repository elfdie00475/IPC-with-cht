...
extern int zwsystem_ipc_setEventStorageDay(stSetEventStorageDayReq stReq, stSetEventStorageDayRep *pRep);
extern int zwsystem_ipc_formatSdCard(stFormatSdCardReq stReq, stFormatSdCardRep *pRep);
extern int zwsystem_ipc_setPtzControlMove(stPtzMoveReq stReq, stPtzMoveRep *pRep);
...
extern int zwsystem_ipc_getCameraBindList(stGetCameraBindListReq stReq, stGetCameraBindListRep *pRep);
